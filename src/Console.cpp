        ...
        for(vector<Skill>::iterator it = davidbalan->skills()->begin(); it != davidbalan->skills()->end(); ++it)
            switch(it->kind())
            {
                case Skill::PROGRAMMING_LANGUAGE:
                    languages << setw(8) << "- " << it->what() << endl;
                    break;
                case Skill::DATABASE:
                    databases << setw(8) << "- " << it->what() << endl;
                    break;
                case Skill::PROJECT:
                    projects << setw(8) << "- " << it->what() << endl;
                    break;
                case Skill::OTHER:
                    others << setw(8) << "- " << it->what() << endl;
                    break;
            }
